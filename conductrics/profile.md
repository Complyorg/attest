...
Privacy-first A/B testing and adaptive targeting platform operating as a data processor with consent-exempt analytics configurations.
...
|------|---------|----------|
| Google Cloud Platform | Cloud hosting | EU |
